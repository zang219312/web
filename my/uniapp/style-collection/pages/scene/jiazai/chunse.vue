<template>
	<view>
		<view class="itemlist list-animation">
			<view class="item">
				<view class="ldx ldx-beat"></view>
				<view>beat</view>
			</view>
			<view class="item">
				<view class="ldx ldx-blink"></view>
				<view>blink</view>
			</view>
			<view class="item">
				<view class="ldx ldx-blur"></view>
				<view>blur</view>
			</view>
			<view class="item">
				<view class="ldx ldx-bounce"></view>
				<view>bounce</view>
			</view>
			<view class="item">
				<view class="ldx ldx-bounceAlt"></view>
				<view>bounceAlt</view>
			</view>
			<view class="item">
				<view class="ldx ldx-breath"></view>
				<view>breath</view>
			</view>
			<view class="item">
				<view class="ldx ldx-clock"></view>
				<view>clock</view>
			</view>
			<view class="item">
				<view class="ldx ldx-coin-h"></view>
				<view>coin-h</view>
			</view>
			<view class="item">
				<view class="ldx ldx-coin-v"></view>
				<view>coin-v</view>
			</view>
			<view class="item">
				<view class="ldx ldx-cycle"></view>
				<view>cycle</view>
			</view>
			<view class="item">
				<view class="ldx ldx-cycle-alt"></view>
				<view>cycle-alt</view>
			</view>
			<view class="item">
				<view class="ldx ldx-damage"></view>
				<view>damage</view>
			</view>
			<view class="item">
				<view class="ldx ldx-dim"></view>
				<view>dim</view>
			</view>
			<view class="item">
				<view class="ldx ldx-fade"></view>
				<view>fade</view>
			</view>
			<view class="item">
				<view class="ldx ldx-flip"></view>
				<view>flip</view>
			</view>
			<view class="item">
				<view class="ldx ldx-flip-h"></view>
				<view>flip-h</view>
			</view>
			<view class="item">
				<view class="ldx ldx-flip-v"></view>
				<view>flip-v</view>
			</view>
			<view class="item">
				<view class="ldx ldx-float"></view>
				<view>float</view>
			</view>
			<view class="item">
				<view class="ldx ldx-heartbeat"></view>
				<view>heartbeat</view>
			</view>
			<view class="item">
				<view class="ldx ldx-hit"></view>
				<view>hit</view>
			</view>
			<view class="item">
				<view class="ldx ldx-jelly"></view>
				<view>jelly</view>
			</view>
			<view class="item">
				<view class="ldx ldx-jelly-alt"></view>
				<view>jelly-alt</view>
			</view>
			<view class="item">
				<view class="ldx ldx-jingle"></view>
				<view>jingle</view>
			</view>
			<view class="item">
				<view class="ldx ldx-jump"></view>
				<view>jump</view>
			</view>
			<view class="item">
				<view class="ldx ldx-measure"></view>
				<view>measure</view>
			</view>
			<view class="item">
				<view class="ldx ldx-metronome"></view>
				<view>metronome</view>
			</view>
			<view class="item">
				<view class="ldx ldx-move-btt"></view>
				<view>move-btt</view>
			</view>
			<view class="item">
				<view class="ldx ldx-move-fade-btt"></view>
				<view>move-fade-btt</view>
			</view>
			<view class="item">
				<view class="ldx ldx-move-fade-ltr"></view>
				<view>move-fade-ltr</view>
			</view>
			<view class="item">
				<view class="ldx ldx-move-fade-rtl"></view>
				<view>move-fade-rtl</view>
			</view>
			<view class="item">
				<view class="ldx ldx-move-fade-ttb"></view>
				<view>move-fade-ttb</view>
			</view>
			<view class="item">
				<view class="ldx ldx-move-ltr"></view>
				<view>move-ltr</view>
			</view>
			<view class="item">
				<view class="ldx ldx-move-rtl"></view>
				<view>move-rtl</view>
			</view>
			<view class="item">
				<view class="ldx ldx-move-ttb"></view>
				<view>move-ttb</view>
			</view>
			<view class="item">
				<view class="ldx ldx-orbit"></view>
				<view>orbit</view>
			</view>
			<view class="item">
				<view class="ldx ldx-pulse"></view>
				<view>pulse</view>
			</view>
			<view class="item">
				<view class="ldx ldx-rubber-h"></view>
				<view>rubber-h</view>
			</view>
			<view class="item">
				<view class="ldx ldx-rubber-v"></view>
				<view>rubber-v</view>
			</view>
			<view class="item">
				<view class="ldx ldx-rush-btt"></view>
				<view>rush-btt</view>
			</view>
			<view class="item">
				<view class="ldx ldx-rush-ltr"></view>
				<view>rush-ltr</view>
			</view>
			<view class="item">
				<view class="ldx ldx-rush-rtl"></view>
				<view>rush-rtl</view>
			</view>
			<view class="item">
				<view class="ldx ldx-rush-ttb"></view>
				<view>rush-ttb</view>
			</view>
			<view class="item">
				<view class="ldx ldx-shake-h"></view>
				<view>shake-h</view>
			</view>
			<view class="item">
				<view class="ldx ldx-shake-v"></view>
				<view>shake-v</view>
			</view>
			<view class="item">
				<view class="ldx ldx-shiver"></view>
				<view>shiver</view>
			</view>
			<view class="item">
				<view class="ldx ldx-skew"></view>
				<view>skew</view>
			</view>
			<view class="item">
				<view class="ldx ldx-skew-alt"></view>
				<view>skew-alt</view>
			</view>
			<view class="item">
				<view class="ldx ldx-slide-btt"></view>
				<view>slide-btt</view>
			</view>
			<view class="item">
				<view class="ldx ldx-slide-ltr"></view>
				<view>slide-ltr</view>
			</view>
			<view class="item">
				<view class="ldx ldx-slide-rtl"></view>
				<view>slide-rtl</view>
			</view>
			<view class="item">
				<view class="ldx ldx-slide-ttb"></view>
				<view>slide-ttb</view>
			</view>
			<view class="item">
				<view class="ldx ldx-smash"></view>
				<view>smash</view>
			</view>
			<view class="item">
				<view class="ldx ldx-spin"></view>
				<view>spin</view>
			</view>
			<view class="item">
				<view class="ldx ldx-spin-fast"></view>
				<view>spin-fast</view>
			</view>
			<view class="item">
			...
			<view class="item">
				<view class="ldx ldx-surprise"></view>
				<view>surprise</view>
			</view>
			<view class="item">
				<view class="ldx ldx-swim"></view>
				<view>swim</view>
			</view>
			<view class="item">
				<view class="ldx ldx-swing"></view>
				<view>swing</view>
			</view>
			<view class="item">
				<view class="ldx ldx-tick"></view>
				<view>tick</view>
			</view>
			<view class="item">
				<view class="ldx ldx-tick-alt"></view>
				<view>tick-alt</view>
			</view>
			<view class="item">
				<view class="ldx ldx-tremble"></view>
				<view>tremble</view>
			</view>
			<view class="item">
				<view class="ldx ldx-vortex"></view>
				<view>vortex</view>
			</view>
			<view class="item">
				<view class="ldx ldx-vortex-alt"></view>
				<view>vortex-alt</view>
			</view>
			<view class="item">
				<view class="ldx ldx-wander-h"></view>
				<view>wander-h</view>
			</view>
			<view class="item">
				<view class="ldx ldx-wander-v"></view>
				<view>wander-v</view>
			</view>
			<view class="item">
				<view class="ldx ldx-wrench"></view>
				<view>wrench</view>
			</view>
		</view>
		<soure :url="url"></soure>
...
<script>
	export default {
		data() {
			return {
				url:'https://ext.dcloud.net.cn/plugin?id=1230'
			};
		},
		onLoad() {},
		methods: {}
...
<style>
	...
	.ldx.ldx-blink {
		animation: ldx-blink 1s infinite linear
	}
	...
	.ldx.ldx-blur {
		animation: ldx-blur 1s infinite linear
	}
	...
	.ldx.ldx-bounceAlt {
		animation: ldx-bounceAlt 1s infinite linear
	}

	@keyframes ldx-tick-alt {
		0% {
	...
	.ldx.ldx-tick-alt {
		animation: ldx-tick-alt 1s infinite linear
	}
	...
	.ldx.ldx-jump {
		animation: ldx-jump 1s infinite linear
	}
	...
	.ldx.ldx-clock {
		animation: ldx-clock 12s infinite linear
	}
	...
	.ldx.ldx-fade {
		animation: ldx-fade 1s infinite linear
	}
	...
	.ldx.ldx-float {
		animation: ldx-float 1s infinite linear
	}

	@keyframes ldx-heartbeat {
		0% {
	...
	.ldx.ldx-heartbeat {
		animation: ldx-heartbeat 1s infinite linear
	}
	...
	.ldx.ldx-hit {
		animation: ldx-hit 2s infinite linear
	}

	@keyframes ldx-move-ltr {
		0% {
			transform: translate(0, 0)
		}
	...
	.ldx.ldx-move-ltr {
		animation: ldx-move-ltr 1s infinite linear
	}

	@keyframes ldx-move-rtl {
		0% {
			transform: translate(0, 0)
		}
	...
	.ldx.ldx-move-rtl {
		animation: ldx-move-rtl 1s infinite linear
	}

	@keyframes ldx-move-ttb {
		0% {
			transform: translate(0, 0)
		}
	...
	.ldx.ldx-move-ttb {
		animation: ldx-move-ttb 1s infinite linear
	}

	@keyframes ldx-move-btt {
		0% {
			transform: translate(0, 0)
		}
	...
	.ldx.ldx-move-btt {
		animation: ldx-move-btt 1s infinite linear
	}

	@keyframes ldx-move-fade-ltr {
		0% {
			transform: translate(0, 0);
			opacity: 1
		}
	...
	.ldx.ldx-move-fade-ltr {
		animation: ldx-move-fade-ltr 1s infinite linear
	}

	@keyframes ldx-move-fade-rtl {
		0% {
			transform: translate(0, 0);
			opacity: 1
		}
	...
	.ldx.ldx-move-fade-rtl {
		animation: ldx-move-fade-rtl 1s infinite linear
	}
	...
	.ldx.ldx-move-fade-btt {
		animation: ldx-move-fade-btt 1s infinite linear
	}
	...
	.ldx.ldx-orbit {
		animation: ldx-orbit 1s infinite linear
	}
	...
	.ldx.ldx-dim {
		animation: ldx-dim 1s infinite linear
	}

	@keyframes ldx-metronome {
		0% {
	...
	.ldx.ldx-swing {
		animation: ldx-swing 1s infinite linear
	}

	@keyframes ldx-wander-v {
		0% {
			animation-timing-function: cubic-bezier(0.9647, 0.2413, -0.0705, 0.7911);
	...
	.ldx.ldx-wander-v {
		animation: ldx-wander-v 1s infinite linear
	}

	@keyframes ldx-wander-h {
		0% {
			animation-timing-function: cubic-bezier(0.9647, 0.2413, -0.0705, 0.7911);
	...
	.ldx.ldx-wander-h,
	.ldx.ldx-wander {
		animation: ldx-wander-h 1s infinite linear
	}
	...
	.ldx.ldx-pulse {
		animation: ldx-pulse 1s infinite linear
	}

	@keyframes ldx-jingle {
		0% {
	...
	.ldx.ldx-rubber-v {
		animation: ldx-rubber-v 1s infinite linear
	}

	@keyframes ldx-rubber-h {
		0% {
			animation-timing-function: cubic-bezier(0.1858, 0.2841, 0.5834, 1.4615);
			transform: scaleX(1)
		}
	...
	.ldx.ldx-rubber-h,
	.ldx.ldx-rubber {
		animation: ldx-rubber-h 1s infinite linear
	}

	@keyframes ldx-shake-v {
		0% {
	...
	.ldx.ldx-shake-v {
		animation: ldx-shake-v 1s infinite linear
	}

	@keyframes ldx-shake-h {
		0% {
	...
	.ldx.ldx-shake-h,
	.ldx.ldx-shake {
		animation: ldx-shake-h 1s infinite linear
	}
	...
	.ldx.ldx-tick {
		animation: ldx-tick 1s infinite linear
	}
	...
	.ldx.ldx-smash {
		animation: ldx-smash 1s infinite linear
	}

	@keyframes ldx-jelly-alt {
		0% {
			animation-timing-function: cubic-bezier(0.1858, 0.2841, 0.5834, 1.4615);
			transform: skewX(0)
		}
	...
	.ldx.ldx-jelly-alt {
		animation: ldx-jelly-alt 1s infinite linear
	}
	...
	.ldx.ldx-jelly {
		animation: ldx-jelly 1s infinite linear
	}

	@keyframes ldx-damage {
		0% {
	...
	.ldx.ldx-damage {
		animation: ldx-damage 1s infinite linear
	}

	@keyframes ldx-rush-ltr {
		0% {
	...
	.ldx.ldx-rush-rtl {
		animation: ldx-rush-rtl 1s infinite linear
	}

	@keyframes ldx-rush-ttb {
		0% {
			animation-timing-function: cubic-bezier(0, 0.5, 0.5, 1);
			opacity: 0
		}
	...
	.ldx.ldx-rush-ttb {
		animation: ldx-rush-ttb 1s infinite linear
	}

	@keyframes ldx-rush-btt {
		0% {
			animation-timing-function: cubic-bezier(0, 0.5, 0.5, 1);
			opacity: 0
		}
	...
	.ldx.ldx-rush-btt {
		animation: ldx-rush-btt 1s infinite linear
	}
	...
	.ldx.ldx-skew {
		animation: ldx-skew 1s infinite linear
	}

	@keyframes ldx-skew-alt {
	...
	.ldx.ldx-skew-alt {
		animation: ldx-skew-alt 1s infinite linear
	}

	@keyframes ldx-slide-ltr {
		0% {
	...
	.ldx.ldx-slide-ltr {
		animation: ldx-slide-ltr 1s infinite linear
	}

	@keyframes ldx-slide-rtl {
		0% {
			animation-timing-function: cubic-bezier(0.4652, 0.1051, 0.774, 0.6426);
			transform: translate(0, 0);
			opacity: 1
	...
	.ldx.ldx-slide-rtl {
		animation: ldx-slide-rtl 1s infinite linear
	}
	...
	.ldx.ldx-slide-ttb {
		animation: ldx-slide-ttb 1s infinite linear
	}
	...
	.ldx.ldx-cycle-alt {
		animation: ldx-cycle-alt 1s infinite linear
	}

	@keyframes ldx-flip-h {
		0% {
	...
	.ldx.ldx-flip-v {
		animation: ldx-flip-v 1s infinite linear
	}

	@keyframes ldx-spin-fast {
		0% {
			animation-timing-function: cubic-bezier(0.5856, 0.0703, 0.4143, 0.9297);
			transform: rotate(0)
		}
	...
	.ldx.ldx-spin-fast {
		animation: ldx-spin-fast 1s infinite linear
	}
	...
	.ldx.ldx-spin {
		animation: ldx-spin 1s infinite linear
	}

	@keyframes ldx-squeeze {
		0% {
	...
	.ldx.ldx-squeeze {
		animation: ldx-squeeze 1s infinite linear
	}


	.ldx.ldx-static {
		animation: ldx-static 1s infinite linear
	}

	@keyframes ldx-surprise {
		0% {
	...
	.ldx.ldx-surprise {
		animation: ldx-surprise 1s infinite linear
	}

	@keyframes ldx-measure {
		0% {
	...
	.ldx.ldx-shiver {
		animation: ldx-shiver .5s infinite linear
	}
	...
	.ldx.ldx-swim {
		animation: ldx-swim 10s infinite linear
	}

	@keyframes ldx-tremble {
		0% {
			transform: translate(0, 0)
		}
	...
	.ldx.ldx-tremble {
		animation: ldx-tremble .5s infinite linear
	}

	@keyframes ldx-vortex {
	...
	.ldx.ldx-vortex {
		animation: ldx-vortex 1s infinite linear
	}

	@keyframes ldx-vortex-alt {
	...
	.ldx.ldx-vortex-alt {
		animation: ldx-vortex-alt 1s infinite linear
	}

	@keyframes ldx-wrench {
	...
	.ldx.ldx-wrench {
		animation: ldx-wrench 1s infinite linear
	}
</style>
