		...
		<view class="u-wrap">
			<view class="jingdong">
				<view class="left">
					...
					<view class="type">满50.01元可用</view>
				</view>
				<view class="right">
					<view class="top">
						<view class="title">
							<text class="tag">限品类东券</text>
							<text>仅可购买电子产品商品</text>
						</view>
						<view class="bottom">
							<view class="date u-line-1">2021.01.01-2021.01.31</view>
			...
			<view class="jingdong">
				...
				<view class="right">
					<view class="top">
						<view class="title">
							<text class="tag">限品类东券</text>
							<text>仅可购买电器部分商品</text>
						</view>
						<view class="bottom">
							<view class="date u-line-1">2021.01.01-2021.01.02</view>
							<view class="immediate-use">立即领取</view>
						</view>
					</view>
					<view class="tips">
						<view class="explain">
...
<style lang="scss" scoped>
	...
	.jingdong {
		...
		.right {
			...
			.top {
				border-bottom: 2rpx dashed #007AFF;
