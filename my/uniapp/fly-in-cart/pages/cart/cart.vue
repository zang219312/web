<template>
	<view class="shoppingcar" :style="minHeight">
		<view class="dianpu" v-for="(item,index) in shopData" :key="index">
			...
			<scroll-view scroll-x="true" class="scrollView" v-for="(ite,ind) in item.data" :key="ind" :id="ite.cart_id"
			 :data-index="ind" :scroll-left="ite.scrollLeft" @touchstart="touchS" @touchend="touchE">
				<view class="viewbox">
					<view class="shangpin">
