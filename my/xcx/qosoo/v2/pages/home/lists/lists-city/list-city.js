...
Page({
  ...
  onLoad: function(option) {
    ...
    this.setData({
      title: option.city,
      listType: option.listType * 1 + 1,
      source: option.listType
    })
    // 生命周期函数--监听页面加载
  ...
  bindCity: function(e) {
    ...
    // wx.redirectTo({
    //   url: '/pages/home/home/home?city=' + e.currentTarget.dataset.city + '&type=' + this.data.listType
    // })
    if (this.data.source == 1) {
      wx.reLaunch({
        url: '/pages/home/exhibition/exhibition?city=' + e.currentTarget.dataset.city + '&type=' + this.data.listType,
      })
    } else if (this.data.source == 2) {
      wx.reLaunch({
        url: '/pages/home/summits/summits?city=' + e.currentTarget.dataset.city + '&type=' + this.data.listType,
      })
    }
