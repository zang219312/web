    ...
    setStyle: function(life) {
      ...
      wx.getSystemInfo({
        success: function(res) {
          topBg = res.model.indexOf('X') > -1 ? 'url(https://file.qosoo.cn/files/20191122/home/184.png)' :'url(https://file.qosoo.cn/files/20191122/home/148.png)'
        },
      })
      ...
      if ((back && !home) || (!back && home)) {
        ...
        navBarLeft = [`width:160px`, `height:${capsulePosition.height}px`, `line-height:${capsulePosition.height}px`].join(';');
