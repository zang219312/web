 ...
 * subInfo
 */
function checkCode(res, source, subInfo) {
  ...
  if (res.data.success === false && res.data.msgType === 1) {
    ...
    if (urlWithArgs.split('?')[0] == 'pages/secretary/secretary') return;
    ...
    timer = setTimeout(function() {
      if (source && subInfo) {
        wx.redirectTo({
          url: '/pages/public/userAuthStatus/userAuthStatus?source=' + source + '&subInfo=' + subInfo
        })
        return
      }
      wx.redirectTo({
